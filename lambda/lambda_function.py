...
# Data (payload) to be sent in POST
data = {
    "contents": [{
        "role":"user",
        "parts": [{
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        data["contents"][0]["parts"][0]["text"] = "Serás mi asistente de I.A. Te daré órdenes e interactuaremos mientras te guiamos y entrenamos."
        ...
        if response.status_code == 200:
            ...
            speak_output = text + " ¿Cómo te puedo ayudar?"
            response_text = {
                "role": "model",
                "parts": [{
                    "text": text
            ...
            speak_output = "Error en la petición"
...
class ChatIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if response.status_code == 200:
            ...
            speak_output = "No recibí respuesta a tu solicitud"
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "Lo siento, no pude hacer lo que me pediste. Inténtalo de nuevo."
